...
namespace Neural_Chess
{
    ...
    public class Chess_Board
    {
        ...
        public Chess_Board(Figures_List field = null, ChessTeam stepTeam = ChessTeam.NONE)
        {
            if (field is null)
                ClearField();
            else
        ...
        public void MoveFigure(BoardPosition firstPos, BoardPosition secondPos)
        {
            ...
            AvailableMove move = movingFigure.AvailableMoves_List.Find(fmove => fmove.Pos == secondPos);
